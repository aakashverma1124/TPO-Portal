      ...
      <div class="row" style="height:100%">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item active" id="admin_home">Home</a>
            <a href="#" class="list-group-item" id="view_profile">View Profile</a>
            <a href="#" class="list-group-item" id="add_company">Add Company</a>
            <a href="#" class="list-group-item" id="view_registered_students">View Registered Students</a>
...
<script>
            ...
            function onViewProfileClicked(){
              var form = document.getElementById("view-profile-form");
              let jsonObject = {};
              for(let field of form.elements) {
                if (field.name) {
                    jsonObject[field.name] = field.value;
              ...
              console.log(JSON.stringify(jsonObject));   
               ...
               success:function(html) {
                 res = html;
                 if(res.indexOf("User does not exists") == -1){
                  document.getElementById("loadedPage").innerHTML = res;
                 }else{
            ...
            function onAddCompanyButtonClicked(){
            ...
            function onVerifyPersonalButtonClicked(){
               $.ajax({
               type: "POST",
            ...
            function onVerifyAcademicButtonClicked(){
               $.ajax({
               type: "POST",
               url: './verify_academic_profile.php',
               success:function(html) {
                 res = html;
                 alert(res);
              },
              ...
              function onViewRegisteredStudentsButtonClicked(){
              var form = document.getElementById("view-registered-students-form");
              let jsonObject = {};
              for(let field of form.elements) {
                if (field.name) {
                    jsonObject[field.name] = field.value;
              ...
              console.log(JSON.stringify(jsonObject));   
               ...
               $.ajax({
               type: "POST",
               url: './registered_students.php',
               data:{action : JSON.stringify(jsonObject)},
               success:function(html) {
                 //res = html;
                 res = html;
                 //window.onload = function(){ alert(res);}
                 document.getElementById("registered-students").innerHTML = res;
                 // var s = document.getElementById("registered-students");
                 // s.value=res;
                 //alert(res);
               },
               error: function (textStatus, errorThrown) {
